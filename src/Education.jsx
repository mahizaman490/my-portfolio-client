  ...
  return (
    <div className="container mx-auto mt-10 p-8  rounded-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 ">
        <div className="education-card hover:shadow-lg transition duration-300 ease-in-out transform hover:-translate-y-1 p-6 rounded-lg border-b-2 border-cyan-700">
          <h2 className="text-2xl font-bold mb-2 text-slate-300">
            <FaGraduationCap className="inline mr-2" />
            Bachelor of Science in Computer Science and Engineering
          </h2>
          <p className="text-lg text-slate-300 mb-1">The International University of Scholars</p>
